...
# python train.py -data en_vi/data/2706.en_vi -save_model en_vi/model/2706.en_vi -rnn_size 100 -word_vec_size 100 -layers 2 -epochs 10 -optim adam  -learning_rate 0.001 -learning_rate_decay 0.9 -start_decay_at 2