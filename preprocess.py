...
# ./tools/embeddings_to_torch.py -emb_file "$glove_dir/glove.6B.100d.txt" -dict_file "$root/data.vocab.pt" -output_file "$root/embeddings"

# python preprocess.py -train_src en_vi/data/train.en -train_tgt en_vi/data/train.vi -valid_src en_vi/data/tst2013.en -valid_tgt en_vi/data/tst2013.vi -save_data en_vi/data/2706.en_vi -src_vocab en_vi/data/vocab.en -tgt_vocab en_vi/data/vocab.vi
